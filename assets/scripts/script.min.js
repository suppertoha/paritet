...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (function (global, factory) {
    ...
    var isTouch =
      'ontouchstart' in win || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints;
    ...
    */
    ...
    var plainItem = function plainItem(panel) {
      ...
      this.isLast =
        this.index === panel.item.parentElement.querySelectorAll(panel.selector).length - 1;
    ...
    var Item = function Item(el, selector) {
      ...
      this.anchor =
        getAttr(el, 'data-anchor') || getOptions().anchors[index(el, getOptions().sectionSelector)];
      this.item = el;
    ...
    function fireCallback(eventName, v) {
      ...
      if (
        getOptions()[eventName].apply(eventData[Object.keys(eventData)[0]], toArray(eventData)) ===
        false
      ) {
        return false;
      }
    ...
    function getBulletLinkName(i, defaultName, item) {
      var anchor =
        defaultName === 'Section' ? getOptions().anchors[i] : getAttr(item, 'data-anchor');
    ...
    function createSlideArrows(section) {
      ...
      if (getOptions().controlArrowColor !== '#fff') {
        ...
        css($(SLIDES_ARROW_PREV_SEL, sectionElem), {
          'border-color':
            'transparent ' + getOptions().controlArrowColor + ' transparent transparent',
        });
      }
    ...
    function didSlidesChange() {
      return (
        getVisible($(getOptions().slideSelector, getContainer())).length !== getState().numSlides
      );
    }
    ...
    */
    ...
    function getEventsPage(e) {
      ...
      events.x =
        typeof e.pageX !== 'undefined' && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX; //in touch devices with scrollBar:true, e.pageY is detected, but we have to deal with touch events. #1008
    ...
    function init$1() {
      ...
      var positionStyle =
        ['left', 'right'].indexOf(position) > -1 ? ''.concat(position, ': 0;') : '';
      ...
      EventEmitter.on('onInitialise', function () {
        ...
        setState({
          isValid:
            ...
            (s &&
              ((getOptions().credits && s && e <= s.v && s.l === n.split(t[0])[4]) ||
                (function (t) {
                  var n = i[r()]().join('');
  ...
  (function (global, factory) {
    ...
    var CONFIGURABLE =
      EXISTS &&
      (!DESCRIPTORS$1 || (DESCRIPTORS$1 && getDescriptor(FunctionPrototype, 'name').configurable));
    var functionName = {
      EXISTS: EXISTS,
      PROPER: PROPER,
	...
	*/
    ...
    var stringPadWebkitBug =
      /Version\/10(?:\.\d+){1,2}(?: [\w./]+)?(?: Mobile\/\w+)? Safari\//.test(userAgent);
        ...
        },
        {
          ...
          value: function splice(start, deleteCount, inserted, removeDirection) {
            ...
            var startChangePos = this.nearestInputPos(
              start,
              deleteCount > 1 && start !== 0 && !this.eager ? DIRECTION.NONE : removeDirection,
            );
            var details = new ChangeDetails({
      ...
      _createClass(PatternInputDefinition, [
        ...
        },
        {
          ...
          value: function nearestInputPos(cursorPos) {
            var direction =
              arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DIRECTION.NONE;
            var minPos = 0;
        ...
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              ...
              (!this.parent ||
                (_this$parent = this.parent).doValidate.apply(_this$parent, arguments))
            );
          },
        },
        {
        ...
        },
        {
          ...
          set: function set(state) {
            ...
            this.chunks = chunks.map(function (cstate) {
              var chunk =
                'chunks' in cstate ? new ChunksTailDetails() : new ContinuousTailDetails(); // $FlowFixMe already checked above
	    ...
	    */
        },
        {
          ...
          value: function remove() {
            ...
            var removeDetails = _get(_getPrototypeOf(MaskedPattern.prototype), 'remove', this).call(
              this,
              fromPos,
              toPos,
            );
        ...
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              ...
              (_get2 = _get(_getPrototypeOf(MaskedRange.prototype), 'doValidate', this)).call.apply(
                _get2,
                [this].concat(args),
              )
            );
	    ...
	    */
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              (_get2 = _get(_getPrototypeOf(MaskedDate.prototype), 'doValidate', this)).call.apply(
                _get2,
                [this].concat(args),
              ) &&
              (!this.isComplete ||
	    ...
	    */
        },
        {
          ...
          value: function maskEquals(mask) {
            return (
              mask === Date ||
              _get(_getPrototypeOf(MaskedDate.prototype), 'maskEquals', this).call(this, mask)
            );
          },
        },
      ]);
        ...
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              ...
              (_get2 = _get(_getPrototypeOf(MaskedEnum.prototype), 'doValidate', this)).call.apply(
                _get2,
                [this].concat(args),
              )
            );
	...
	*/
	    ...
	    */
        ...
        },
        {
          ...
          value: function _separatorsCountFromSlice() {
            var slice =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._value;
        ...
        },
        {
          ...
          value: function extractInput() {
            ...
            return this._removeThousandsSeparators(
              _get(_getPrototypeOf(MaskedNumber.prototype), 'extractInput', this).call(
                this,
                fromPos,
                toPos,
                flags,
        ...
        },
        {
          ...
          value: function _appendCharRaw(ch) {
            ...
            if (!this.thousandsSeparator)
              return _get(_getPrototypeOf(MaskedNumber.prototype), '_appendCharRaw', this).call(
                this,
                ch,
                flags,
              );
	    ...
	    */
        },
        {
          ...
          value: function doValidate(flags) {
            ...
            return (
              valid &&
              _get(_getPrototypeOf(MaskedNumber.prototype), 'doValidate', this).call(this, flags)
            );
          },
          /**
	      @override
        ...
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              ...
              (!this.currentMask ||
                (_this$currentMask = this.currentMask).doValidate.apply(_this$currentMask, args))
            );
          },
          /**
	      @override
	    */
        },
        {
          ...
          value: function reset() {
            ...
            (_this$currentMask2 = this.currentMask) === null || _this$currentMask2 === void 0
              ? void 0
	    ...
	    */
        },
        {
          ...
          get: function get() {
            ...
            return Boolean(
              (_this$currentMask3 = this.currentMask) === null || _this$currentMask3 === void 0
                ? void 0
	    ...
	    */
        },
        {
          ...
          get: function get() {
            ...
            return Boolean(
              (_this$currentMask4 = this.currentMask) === null || _this$currentMask4 === void 0
                ? void 0
          ...
          value: function maskEquals(mask) {
            return (
              ...
              this.compiledMasks.every(function (m, mi) {
                ...
                return m.maskEquals(
                  (_mask$mi = mask[mi]) === null || _mask$mi === void 0 ? void 0 : _mask$mi.mask,
                );
              })
            );
          },
    ...
    function createPipe(mask) {
      var from =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : PIPE_TYPE.MASKED;
  ...
  if (window.innerWidth < 1200) {
    ...
    const navLinksM = document.querySelectorAll('.nav__link');
    const shadowM = document.querySelector('.shadow-box');
    const burgerM = document.querySelector('.burger');
    const bodyM = document.querySelector('.body');
    
    navLinksM.forEach(navLink => {
      navLink.addEventListener('click', function() {
        shadowM.classList.remove('open');
        navM.classList.remove('open');
        burgerM.classList.remove('open');
        bodyM.classList.remove('overflow');
      });
    });
